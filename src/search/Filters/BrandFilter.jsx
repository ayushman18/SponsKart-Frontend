...
const BrandFilter = ({ handelFilterSearch }) => {
   ...
   return (
      <div>
         <div className="text-2xl mx-4 font-semibold text-green-600 py-8">Filter Brand By</div>
         <div className="hidden md:block">
            <div className="collapse collapse-arrow rounded-none border-b border-[#5252526E]">
               <input type="radio" name="my-accordion-2" />
               <div className="collapse-title bg-[#5252523D] text-xl font-medium">Brand Type</div>
