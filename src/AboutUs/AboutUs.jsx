      ...
      <section className="container mx-auto my-10">
         ...
         <div>
            ...
            <p className="text-gray-700">
               ...
               brands reach their target audience and achieve their marketing goals through strategic
               sponsorships.
            </p>
            <br />
            ...
            <p className="text-gray-700">
               ...
               network of sponsors from various industries and helps event organizers find the perfect
            ...
            <p className="text-gray-700">
               ...
               partnering with influencers to promote their products or services. Sponskart helps influencers
               monetize their social media presence by connecting them with relevant brands for sponsored
               content.
            </p>
            <br />
            ...
            <p className="text-gray-700">
               ...
               achieves the desired results. Sponskart also helps brands measure the success of their
               sponsorships by providing them with detailed reports on audience engagement, reach, and other
               metrics.
            </p>
            <br />
